...
def sentence_bleu(
    ...
    BLEU is a method for automatic evaluation of machine translation quality.

    Original example and explanation from the paper are retained below:
    ...
    Note:
        The BLEU score is calculated based on the n-gram precision with an
        optional smoothing function to handle zero n-gram overlap.

    References:
        - Papineni, K., Roukos, S., Ward, T., & Zhu, W. J. (2002).
          BLEU: a method for automatic evaluation of machine translation.
          In Proceedings of ACL (Vol. 2, pp. 311-318).
    """
    return corpus_bleu(
