EXAMPLES = [
    ...
    { "name": "requests.get", "description": "Sends a GET request to the specified URL.", "parameters": { "type": "dict", "properties": { "url": { "type": "string", "description": "The OMDb API allows you to retrieve detailed information about movies, TV series, and episodes. User can search for things like year of release, plot summaries, and age ratings. More information can be found in https://www.omdbapi.com/", "default": "http://www.omdbapi.com/" }, "headers": {}, "timeout": { "type": ["number", "tuple"], "description": "How many seconds to wait for the server to send data before giving up.", "required": false }, "params": { "i": { "type": "string", "description": "A valid IMDb ID (e.g., tt1285016).", "required": false }, "t": { "type": "string", "description": "Movie title to search for.", "required": false }, "type": { "type": "string", "description": "Type of result to return. Valid options are 'movie', 'series', and 'episode'.", "required": false }, "y": { "type": "string", "description": "Year of release.", "required": false }, "plot": { "type": "string", "description": "Return short or full plot. Default is 'short'.", "required": false }, "r": { "type": "string", "description": "The data type to return. Default is 'json'.", "required": false }, "callback": { "type": "string", "description": "JSONP callback name.", "required": false }, "v": { "type": "integer", "description": "API version (reserved for future use). Default is 1.", "required": false } }, "allow_redirects": { "type": "boolean", "description": "A Boolean to enable/disable redirection.", "default": true, "required": false }, "auth": { "type": "tuple", "description": "A tuple to enable a certain HTTP authentication.", "default": "None", "required": false }, "cert": { "type": ["string", "tuple"], "description": "A String or Tuple specifying a cert file or key.", "default": "None", "required": false }, "cookies": { "type": "dict", "additionalProperties": { "type": "string" }, "description": "Dictionary of cookies to send with the request.", "required": false }, "proxies": { "type": "dict", "additionalProperties": { "type": "string" }, "description": "Dictionary of the protocol to the proxy url.", "required": false }, "stream": { "type": "boolean", "description": "A Boolean indication if the response should be immediately downloaded (False) or streamed (True).", "default": false, "required": false }, "verify": { "type": ["boolean", "string"], "description": "A Boolean or a String indication to verify the servers TLS certificate or not.", "default": true, "required": false } } } },
